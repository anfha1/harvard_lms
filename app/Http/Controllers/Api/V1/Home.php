...
class Home extends Controller
{
    ...
    // Lấy thông tin quyền Course
    public function manage_role_book_get(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // đặt quyền người dùng Course
    public function manage_role_book_set(Request $request) {
        $res = App::Res();
        $info = App::CheckLogin($request);
        $request_all = $request->all();
    ...
    // tạo Khối (lớp) mới yêu cầu quyền admin
    public function manage_book_create(Request $request) {
        $res = App::Res();
        $info = App::CheckLogin($request);
    ...
    // sửa Khối (lớp) yêu cầu quyền admin
    public function manage_book_edit(Request $request) {
        $request_all = $request->all();
        $res = App::Res();
    ...
    // tắt hiển thị lớp
    public function manage_book_off(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // hiển thị lớp
    public function manage_book_show(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // xoá khối (lớp)
    public function manage_book_delete(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // tạo tiết mới yêu cầu quyền admin
    public function manage_book_session_create(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // sửa tiết yêu cầu quyền admin
    public function manage_book_session_edit(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // hiển thị tiết
    public function manage_book_session_show(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // tắt hiển thị tiết
    public function manage_book_session_off(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // xoá tiết
    public function manage_book_session_delete(Request $request) {
        $res = App::Res();
        $request_all = $request->all();
    ...
    // upload pdf
    public function manage_book_pdf_upload(Request $request) {
        $res = App::RES_FORM;
        $all_request = $request->all();
    ...
    // delete pdf
    public function manage_book_pdf_delete(Request $request) {
        $res = App::RES_FORM;
        $all_request = $request->all();
        if (Validate::number($res, $all_request, 'session_id', 'Tiết')) {
            $info = App::CheckLogin($request);
